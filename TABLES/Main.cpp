...
void main(void) {
	...
	char* menu1[7] = {
		(char*)"Èçìåíèòü àêòèâíóþ òàáëèöó",
		(char*)"Äîáàâèòü ïîëèíîì â òàáëèöû",
		(char*)"Óäàëèòü ïîëèíîì èç òàáëèö",
		(char*)"Íàéòè ïîëèíîì ïî èìåíè",
		(char*)"Âûâåñòè âñå ïîëèíîìû",
		(char*)"Âû÷èñëèòü ïîëèíîì â çàäàííîé òî÷êå",
		(char*)"Âû÷èñëèòü âûðàæåíèå èç ïîëèíîìîâ"
	};
	int selector = 0;
	int activeTable = 0;
	string str;
	while (selector != KEY_EXIT) {
		...
		case 0: {
			...
			case 0: {
				system("cls");
				cout << "Âûáðàíà List òàáëèöà" << endl;
				system("pause");
				break;
			}
			case 1: {
				system("cls");
				cout << "Âûáðàíà õåø òàáëèöà ñ îòêðûòûì ïåðåìåøèâàíèåì" << endl;
				system("pause");
				break;
			}
			case 2: {
				system("cls");
				cout << "Âûáðàíà õåø òàáëèöà ñ ìåòîäîì öåïî÷åê" << endl;
				system("pause");
				break;
			}
			case 3: {
				system("cls");
				cout << "Âûáðàíî ÀÂË äåðåâî" << endl;
				system("pause");
				break;
			}
			case 4: {
				system("cls");
				cout << "Âûáðàíà ëèíåéíàÿ òàáëèöà" << endl;
				system("pause");
				break;
			}
			case 5: {
				system("cls");
				cout << "Âûáðàíà òàáëèöà íà ìàññèâå" << endl;
				system("pause");
				break;
			}
			}
